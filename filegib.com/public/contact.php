...
<html>
	...
	<body>
		...
		<form id="searchbar" method="post" action="search.php">
			...
			<div style="padding-left:42%; font-family:arial; padding-top: 5px;">
			<strong>General inquiries, questions, comments:</strong><br/>
			comments@filegib.com
			<br/><br/>
			<strong>Copyright inquiries:</strong><br/>
			copyright@filegib.com
			<br/><br/>
			<strong>Account support:</strong><br/>
			help@filegib.com
			<br/><br/>
			<strong>Business and/or partnership inquiries:</strong><br/>
			business@filegib.com
			<br/>
			</div>
		<div id="footer">
				<div id="bottomlist">
