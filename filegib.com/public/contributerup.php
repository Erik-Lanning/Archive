		...
		<form id="searchbar" method="post" action="search.php">
			...
			<div style="width:500px; margin-left: 29.5%;">
				...
				<div id="contributerinfo" style="width:500px; margin-left: 30%;">
					...
					<br/>
					<br/>
					<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" style="margin-left: 35%;">
					<input type="hidden" name="cmd" value="_s-xclick">
					<input type="hidden" name="hosted_button_id" value="JQR87PM88MH64">
